    ...
    this.nextPrevHandler = function(ev) {
      ...
      if (clickedEl.is('.previous')) {
        ...
        if(!routing.pushStateLock) {
          //TODO
          let newDataRoute = jQuery.extend(true, {}, routing.currState);
          let lastPage = routing.currState.page;
          ...
          routing.pushDataRouteInWindowUrl(newDataRoute);
        ...
        if(clickedEl.text().indexOf('Next') >= 0 && !routing.pushStateLock){
          let newDataRoute = jQuery.extend(true, {}, routing.currState);
          let lastPage = routing.currState.page;
          let currPage = lastPage += 1;
          newDataRoute.page = currPage;
